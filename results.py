...
def get_image_embeddings(valid_df, model_path, subnet=0):
...
def find_matches(model, image_embeddings, query, image_filenames, n=9, subnet=0):
    ...
    plt.savefig(f'Best_ResnetDynabert_big_small_sampling_{subnet}.png')

subnet = 107
_, valid_df = make_train_valid_dfs()
model, image_embeddings = get_image_embeddings(valid_df, "Best_ResnetDynabert_big_small_sampling.pt", subnet=subnet)
